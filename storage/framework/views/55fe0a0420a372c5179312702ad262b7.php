    ...
    <div class="container-fluid">
        ...
        <div class="accordion" id="loginUrlAccordion">
            <div class="accordion-item">
                ...
                <?php else: ?>
                    <span class="badge bg-success mb-3">Limite do Usuário: <?php echo e($user->limite); ?></span>
                <?php endif; ?>
            </div>
                        ...
                        <table id="table" data-toggle="table" data-loading-template="loadingTemplate"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="mac" data-visible="<?php echo e(in_array('mac', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>" data-sortable="true">MAC</th>
                                    ...
                                    <th data-field="numero_de_telas" data-visible="<?php echo e(in_array('numero_de_telas', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>" data-sortable="true">Número de Telas</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gestor-pro.vipconnect.top/public_html/resources/views/content/apps/app-ecommerce-customer-all.blade.php ENDPATH**/ ?>