                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column m-sm-3 m-0">
                        <div class="mb-xl-0 mb-4">
                            ...
                            <p class="mb-2">WhatsApp da Empresa: <?php echo e($empresa->company_whatsapp); ?></p>
                        </div>
                        <div>
                            <?php
                            use Carbon\Carbon;
                            ...
                            <div class="mb-2 pt-1">
                                ...
                                <span class="fw-medium">
                                    <?php echo e($payment->created_at ? $payment->created_at->translatedFormat('d F, Y') : 'N/A'); ?>
                    ...
                    <table class="table m-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo e($payment->created_at ? $payment->created_at->translatedFormat('d F, Y, H:i') : 'N/A'); ?></td>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gestor-pro.vipconnect.top/public_html/resources/views/content/apps/detalhes.blade.php ENDPATH**/ ?>