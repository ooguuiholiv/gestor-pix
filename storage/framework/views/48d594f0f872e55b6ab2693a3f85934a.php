...
<?php $__env->startSection('page-script'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/dashboards-crm.js')); ?>"></script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            fetch('<?php echo e(route('api.updates')); ?>')
                ...
                .then(data => {
                    ...
                    const currentVersion = '<?php echo e(env('APP_VERSION', '1.0.0')); ?>'; // Obter a versão atual da aplicação
                ...
                <div class="d-flex align-items-end row">
                    <div class="col-7">
                        <div class="card-body text-nowrap">
                            <?php if($clienteMaisCompras): ?>
                                <h5 class="card-title mb-0">Parabéns <?php echo e($clienteMaisCompras->nome); ?>! 🎉</h5>
                                <p class="mb-2">Melhor comprador do mês</p>
                                <h4 class="text-primary mb-1">
                                    R$<?php echo e(number_format($totalComprasClienteMaisCompras, 2, ',', '.')); ?></h4>
                                <a href="<?php echo e(route('app-ecommerce-order-list', ['order_id' => $clienteMaisCompras->id])); ?>"
                    ...
                    <div class="col-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                            <img src="<?php echo e(asset('assets/img/illustrations/card-advance-sale.png')); ?>" height="140"
                                alt="view sales">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gestor-pro.vipconnect.top/public_html/resources/views/content/apps/app-ecommerce-dashboard.blade.php ENDPATH**/ ?>