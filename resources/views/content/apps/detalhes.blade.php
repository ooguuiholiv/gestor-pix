                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column m-sm-3 m-0">
                        <div class="mb-xl-0 mb-4">
                            ...
                            <p class="mb-2">WhatsApp da Empresa: {{ $empresa->company_whatsapp }}</p>
                        </div>
                        <div>
                            @php
                            use Carbon\Carbon;
                            ...
                            <div class="mb-2 pt-1">
                                ...
                                <span class="fw-medium">
                                    {{ $payment->created_at ? $payment->created_at->translatedFormat('d F, Y') : 'N/A' }}
                                </span>
                            </div>
                            <div class="pt-1">
                    ...
                    <table class="table m-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $payment->created_at ? $payment->created_at->translatedFormat('d F, Y, H:i') : 'N/A' }}</td>
