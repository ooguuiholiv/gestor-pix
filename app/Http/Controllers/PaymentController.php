...
class PaymentController extends Controller
{
    ...
    {
        // Atualizar a data de término do período de teste
        ...
        // Adicionar saldo de indicação ao usuário que fez a indicação
 ...
 // Obter o access_token correspondente da tabela company_details usando o user_id do administrador
      ...
      Log::info('Access Token encontrado: ' . $accessToken);
        ...
        try {
            ...
            // Log::info('Pagamento criado com sucesso.' . json_encode($response));
